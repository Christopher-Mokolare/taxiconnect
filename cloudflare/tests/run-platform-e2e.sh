...
await req("passenger rank waiting","POST","/api/passenger/waiting",{passenger:true,body:{routeId:"e2e-route",originPointId:"e2e-origin",destinationPointId:"e2e-destination",requestMode:"RANK",pickupPointId:"e2e-origin",groupSize:2}});
